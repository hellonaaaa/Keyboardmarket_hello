        ...
        <div id="app">
            ...
            <div id="registerForm" style="width: 50%; height: 500px">
                <b-form @submit="onSubmit" @reset="onReset">
                    ...
                    <b-form-group id="password1_group" label="請確認密碼:" label-for="password1" style="margin: 10px">
                        <b-form-input id="password1" placeholder="請再次輸入密碼" type="password" v-model="password1" required>
                        </b-form-input>
                        <div v-show="!isValid">
                            {{ password1ErrMsg }}
                        </div>
                    </b-form-group>
                    <b-form-group id="email_group" label="電話:" label-for="phone" style="margin: 10px">
                        <b-form-input id="phone" placeholder="請輸入電話" v-model="phone" required> </b-form-input>
                        <div v-show="!isValid">
                            {{ phoneErrMsg }}
                        </div>
                    </b-form-group>
                    <b-form-group id="email_group" label="電子郵件:" label-for="email" style="margin: 10px">
                        <b-form-input id="email" placeholder="請輸入E-mail" type="email" v-model="email" required> </b-form-input>
                        <div v-show="!isValid">
                            {{ emailErrMsg }}
                        </div>
                    </b-form-group>
                    <b-form-group id="address_group" label="地址:" label-for="address" style="margin: 10px">
                        <b-form-input id="address" placeholder="請輸入地址" v-model="address" required> </b-form-input>
                        <div v-show="!isValid">
                            {{ addressErrMsg }}
                        </div>
                    </b-form-group>
...
<script>
import { CREATED } from "@/apis/constant"
